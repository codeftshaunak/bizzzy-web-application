      ...
      <div className="max-w-[1280px] pt-[56px] mx-auto px-5">
        ...
        <Tabs variant="unstyled">
          <TabList className="w-full">
            <div className="main-tab-wrapper relative lg:mb-[30px] mb-6">
              <div className="flex space-x-[26px] relative z-10">
                <Tab
                  type="button"
                  className=" font-medium text-lg py-3 border-b-4 border-primary"
                >
                  Billing & Earning
                </Tab>
                <Tab
                  type="button"
                  className="text-gray-300 font-medium text-lg py-3 border-b-4 border-transparent"
                >
                  Lifetime billed
                </Tab>
              </div>
              ...
              <div className="tab-body">
                ...
                <div className="w-full border rounded-[10px]  flex lg:flex-row flex-col min-h-[561px]">
                  <div className="lg:w-[250px] w-full py-10 px-6 flex lg:flex-col lg:items-start lg:border-r lg:space-y-3 space-x-3 lg:space-x-0 flex-wrap lg:flex-nowrap">
                    <button className="hover:bg-primary bg-transparent text-gray-300 hover:text-white leading-5 px-2.5 py-[6px] rounded-md hover:font-normal font-medium transition duration-300 ease-in-out">
                      Anthony Media Group
                    </button>
                    <button className="hover:bg-primary bg-transparent text-gray-300 hover:text-white leading-5 px-2.5 py-[6px] rounded-md hover:font-normal font-medium transition duration-300 ease-in-out">
                      Benji Hochberg
                      ...
                      <div className="border rounded-[10px] overflow-hidden">
                        <div className="bg-gray-50 p-5 ">
                          <p className="text-xl leading-7 font-medium text-gray-400 mb-3">
                            Your Earning After Upwork Fees & Taxes
                          </p>
