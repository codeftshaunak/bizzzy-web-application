...
const ClientDetailsSection = ({ clientDetails, status, acceptInvite, rejectInvite, setOpenModal }) => {
    return (
        <VStack padding="2rem 3rem" borderRadius="10px" width="400px" alignItems="start">
            <Text fontSize="xs" mb="15px" textAlign="center">Interested in discussing this job</Text>
            <VStack>
