    ...
    return (
        <VStack width={"100%"}>
            <HStack justifyContent={"space-between"} width={"100%"}>
                <Text fontWeight={"500"} fontSize={"20px"} color={"black"}>Your Gigs</Text>
                ...
                }} onClick={() => setPage(2)}>Create New Gig</Button>
            </HStack>
            <HStack width={"100%"} marginTop={"1rem"} border={"1px solid #d8d8d8"} borderRadius={"5px"}>
                <GigStatus />
            </HStack>
        </VStack>
    )
