        ...
        <div className="col-span-12 md:col-span-9">
          ...
          {uniqueHired?.length > 0 ? (
            <div className="grid grid-cols-12 gap-4 mt-4">
              {uniqueHired?.length > 0 &&
                uniqueHired.map((data, index) => {
                  return (
                    <div
                      className="col-span-12 md:col-span-6 lg:col-span-4 border border-[#D1D5DB] p-4 rounded-lg"
                      key={index}
                    >
                      ...
                      >
                        ...
                        >
                          <HStack>
                            ...
                            <div className=" text-[#6B7280] text-base font-bold">
                              Applicants
                            </div>
                          </HStack>
