        ...
        <div className="w-[90%]">
            <div className="grid grid-cols-12 gap-4">
                <div className="col-span-12 md:col-span-9">
                    ...
                    <hr />
                    <div className="text-2xl font-medium text-[#374151] mt-4">Your Agency Team</div>
                    {
                        uniqueHired?.length > 0 ? <div className="flex justify-between mt-4">
                            {
                                uniqueHired?.length > 0 && [1, 2, 3].map((index) => {
                                    const data = uniqueHired[0]; // Adjusted index to get the correct element
                                    return (
                                        <div className="col-span-12 md:col-span-6 lg:col-span-4 border border-[#D1D5DB] p-4 rounded-lg w-[300px] bg-[#f4f5f787]" key={index}>
                    ...
                    <div className="border-2 mt-4 rounded-md">
                        <div className="flex justify-between border-b border-[#D1D5DB] p-4">
                            <div className=" text-2xl font-medium text-[#374151]">Your Packages</div>
                        </div>
                        <div className=" h-[200px] bg-[#f4f5f787] text-center py-4">
                            <div className="w-[70%] m-auto flex flex-col justify-center items-center gap-2 h-full">
