    ...
    <div className="w-[90%]">
      <div className="grid grid-cols-12 gap-4">
            ...
            <div className="flex justify-between mt-4">
              {uniqueHired?.length > 0 &&
                [1, 2, 3].map((index) => {
                  ...
                  return (
                    <div
                      className="col-span-12 md:col-span-6 lg:col-span-4 border border-[#D1D5DB] p-4 rounded-lg w-[300px] bg-[#f4f5f787]"
                      key={index}
                    >
        ...
        <div className="w-[300px] flex flex-col m-auto justify-center items-center">
          ...
          <UserProfileCard />
          <button
            className="bg-[#16A34A] text-[#fff] border-2 border-[#16A34A] text-md w-[90%] text-center mt-4  rounded-md font-semibold py-1"
